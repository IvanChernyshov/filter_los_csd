This is example of the ConQuest search results for N···O contacts as part of CNO<sub>2</sub>···O=X systems (X is any atom) and the subsequent search of line-of-sight contacts using filter_los_csd.py script.
